...
!     gfortran -o qcomnonlinear -fdefault-double-8 -fdefault-real-8 Eng_QCOM_nonlinear.f90
...
!     Added f90 declarations and procedures.
      ...
      real, dimension (1:jv, 1:kv, 1:2) :: fv
...
!     including values for boundary points for v, w, theta, pi.
      ...
      real, dimension (1:jw, 1:kw, 1:2) :: fw

      real, dimension (0:jth+1, 0:kth+1) :: thetao
      real, dimension (0:jth+1, 0:kth+1) :: theta
      real, dimension (1:jth, 1:kth, 1:2) :: ftheta

      real, dimension (0:jp+1, 0:kp+1) :: pi
      real, dimension (1:jp, 1:kp, 1:2) :: fpi

      parameter (tmax = 3000., dt = .5) 
